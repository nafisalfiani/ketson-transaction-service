...
func shortFuncName(f *runtime.Func) string {
	...
	// - "github.com/nafisalfiani/ketson-api-gateway-service/lib/<package>.<FuncName>"
	// - "github.com/nafisalfiani/ketson-api-gateway-service/lib/<package>.<Receiver>.<MethodName>"
	// - "github.com/nafisalfiani/ketson-api-gateway-service/lib/<package>.<*PtrReceiver>.<MethodName>"
	longName := f.Name()
